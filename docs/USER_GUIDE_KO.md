...
이 안내서는 MCastTalk `0.2.40-alpha`의 사용법을 설명합니다. 새 기능의 사용 조건은 11절을 확인하세요.
...
1. GitHub 저장소의 [Releases](https://github.com/dashjeong/MCastTalk/releases)에서 검증된 `MCastTalk-0.2.40-alpha.apk` 파일을 다운로드합니다.
