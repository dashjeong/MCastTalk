...
assert.match(build, /versionCode\s*=\s*43\b/);
...
assert.equal(read('LICENSE'), read('app/src/main/assets/licenses/POLYFORM-NONCOMMERCIAL-1.0.0.txt'),
  'The in-app license must exactly match the repository license, including scope and required notices.');
