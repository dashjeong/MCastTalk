...
> **0.2.45-beta 후보 — 구어체 문장 확정 지연 보완**
> 혼자 이어서 말할 때 완료된 구어체 문장을 먼저 번역으로 넘기고 미완 문장은 보존합니다.
> 방송·통역 진입을 합치고 음성노트는 본문 중심 화면과 선택형 상세보기로 정리했습니다.
> [이번 Beta 검증 결과](docs/BETA_0_2_45_VALIDATION.md)는 실행 완료와 번역 품질의 한계를 구분합니다.
> 최종 가상 마이크 검증의 입력 누락을 조사 중이므로 새 APK 공개는 아직 보류입니다.
...
**0.2.45-beta — 서비스 홈·음성노트·문맥 검토 및 구어체 문장 확정 보완**
...
[현재 공개 APK: 0.2.44 Alpha](https://github.com/dashjeong/MCastTalk/releases/tag/v0.2.44-alpha) ·
[실행한 시험과 그 한계](docs/TEST_REPORT.md)
(검증 중 후보: `0.2.45-beta`, `versionCode 51`). 기존 공개 앱과 같은 패키지 ID와 배포자 서명을 사용합니다.
