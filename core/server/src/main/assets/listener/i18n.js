...
globalThis.GuideCastI18n = (() => {
  ...
  const rows = {
    ...
    "스크립트 갱신 지연 · 이전 내용 유지": ["Transcript update delayed · showing previous text", "テキスト更新遅延・過去の内容を表示中", "文字更新延迟·正在显示先前内容", "文字更新延遲·正在顯示先前內容", "Cập nhật văn bản bị trễ · hiển thị nội dung trước", "Tekstupdate vertraagd · eerdere inhoud wordt getoond", "Actualización de transcripción demorada · mostrando texto anterior", "تأخر تحديث النص · يتم عرض النص السابق"],
